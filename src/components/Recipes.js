...
function Recipes() {
    ...
    return (
        <>
            {/* Banner Section */}
            <section className='recipe flex flex-wrap justify-center gap-20 py-20'>
                ...
                <LazyLoadImage className='h-96 w-[25%] rounded-full' src={image} alt="" />
            </section>
            ...
            <section className='my-20'>
                ...
                <div className='grid grid-cols-1 lg:grid-cols-3 gap-8 mt-12 px-20'>
                    {
                        recipelist.map(data => (
